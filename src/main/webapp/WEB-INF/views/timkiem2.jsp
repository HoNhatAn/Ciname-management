						...
						<div class="ucm-nav-wrap">
							<ul class="nav nav-tabs" id="myTab" >
								<li class="nav-item" role="presentation"><a
									...
									href="#" role="tab" aria-controls="movies"
									aria-selected="false">Movies HOT</a></li>
							</ul>
						</div>
					</div>
				</div>
				<c:if test="${Phimtimkiem.size()==0  || Phimtimkiem==null}">
								<h1 style="text-align: center">Không tìm thấy phim</h1>
							</c:if>
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active" id="tvShow" role="tabpanel"
						...
						<div class="ucm-active-two owl-carousel">
							...
							<c:forEach items="${Phimtimkiem }" var="item">
							<div class="movie-item movie-item-two mb-30"   style="background-repeat: no-repeat">
							<%-- <c:url value="/chitiet/${item.id}" var="myURL">
								<c:param name="" value="${item.slug_ten_phim }"></c:param>	
								</c:url> --%>
