						...
						<div class="contact-form-wrap" style="text-align: center;">
							...
							<div class="contact-form" style="border: none; opacity: 0.8">
								<form:form method="post" action="register"
									...
									<div class="col-md-12">
										<form:input type="password" id="password" path="password" placeholder="Mật Khẩu"/>
										<form:errors path="password" cssClass="error" />
									</div>
									<div class="col-md-12">
										
										<form:input path="cfpassword" type="password" id="cfpassword"  placeholder="Xác Nhận Mật Khẩu"/>
